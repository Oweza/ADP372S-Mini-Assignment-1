...
The system is open for extension but closed for modification. New student types (e.g. Part-Time Student) can be added by extending the Student class. Existing classes do not need to be modified to support new student types
